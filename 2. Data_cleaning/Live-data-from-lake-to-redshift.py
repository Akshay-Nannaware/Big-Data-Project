...
bucket_name = 'datalake-rawzone-group1dbda-8sep'
#prefix = 'your_prefix/'  # Optional: specify a prefix if your files are in a specific directory

article_response = s3_client.list_objects_v2(Bucket=bucket_name,Prefix='Articles/Articles_Live/')
...
customer_response = s3_client.list_objects_v2(Bucket=bucket_name,Prefix='Customers/Customers_Live/')
...
transaction_response = s3_client.list_objects_v2(Bucket=bucket_name,Prefix='Transactions/Transactions_Live/')
...
aws_creds={"aws_access_key_id":"ASIA4A7XMGYJ6TE5BHOA","aws_secret_access_key":"LJx3aBARjqYGuJSWAvfUktvgTXCUORHX6Hgkue/7","aws_session_token":"","region_name":"us-east-1"}
...
redshift_temp_dir = "s3://redshift-logs-group1dbda-8sep/red-logs"
