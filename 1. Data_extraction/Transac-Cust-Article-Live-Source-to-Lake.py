...
customers_df.repartition(1).write.mode('overwrite').parquet(f"s3://datalake-rawzone-group1dbda-8sep/Customers/Customers_Live/{current_date_string}/")

articles_df.repartition(1).write.mode('overwrite').parquet(f"s3://datalake-rawzone-group1dbda-8sep/Articles/Articles_Live/{current_date_string}/")

transaction_df.repartition(1).write.mode('append').parquet(f"s3://datalake-rawzone-group1dbda-8sep/Transactions/Transactions_Live/{current_date_string}/")
